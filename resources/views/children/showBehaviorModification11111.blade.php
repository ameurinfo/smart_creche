...
<div class="card">
    ...
    <div class="card-body">
        <p><strong>اسم الطفل:</strong> {{ $student->name }}</p>
        <p><strong>تاريخ الولادة:</strong> {{ $student->birthdate }}</p>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        @foreach ($student->psychological_follow_up as $behaviorModification)
...
<div class="mt-4">
    <a href="{{ route('children.indexBehaviorModification') }}" class="btn btn-primary">العودة إلى القائمة</a>
</div>
@endsection